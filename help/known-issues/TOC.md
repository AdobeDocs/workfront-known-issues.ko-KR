...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront]{#wf-current}의 현재 문제
      ...
      + [작업 및 문제: 작업 또는 문제를 만드는 도중 의도치 않게 종료](known-issues-workfront/wf-inadvertent-exit-creating-tasks-or-issues.md)
   ...
   + [!DNL Adobe Workfront]{#wf-resolved}의 해결된 문제
      ...
      + [타임시트: 타임시트를 만드는 도중 오류 발생](known-issues-workfront/resolved-issues-wf/wf-timesheets-issues-creating-timesheets.md)
