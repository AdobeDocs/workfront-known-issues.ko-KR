...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront]{#wf-current}의 현재 문제
      ...
      + [홈: 우선순위 영역이 비활성화된 경우에도 액세스할 수 있음](known-issues-workfront/wf-home-priorities-accessible.md)
      ...
      + [교정쇄: Fusion을 통해 AEM에서 연결된 문서에 대한 교정쇄 생성 실패](known-issues-workfront/wf-proof-linked-aem-fusion-docs-dont-generate.md)
      ...
      + [교정쇄: 활성 사용자가 비활성화된 것으로 나타남](known-issues-workfront/wf-proofs-active-users-appear-as-deactivated.md)
      ...
      + [교정쇄: 교정쇄를 열면 여러 사본이 열림](known-issues-workfront/wf-proofs-two-proofs-open.md)
      ...
      + [Workfront Mobile: 교정쇄를 열 수 없음](known-issues-workfront/wf-mobile-proofs-not-open.md)
      ...
      + [교정쇄: 교정쇄를 닫으면 제품 문서 페이지로 연결됨](known-issues-workfront/wf-proofs-closing-leads-to-project-docs.md)
      ...
      + [교정쇄: 교정쇄 이름을 클릭하면 빈 화면이 표시됨](known-issues-workfront/wf-proofs-go-to-blank-screen.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + [!DNL Workfront Proof]{#proof-current}의 현재 문제
      ...
      + [Workfront Proof: 데스크탑 교정쇄 뷰어의 업데이트 섹션에 콘텐츠가 잘못 붙여넣어짐](known-issues-workfront-proof/proof-wrong-content-pastes-in-viewer-updates.md)
...
+ [!DNL Adobe Workfront Fusion] {#fusion}
   ...
   + [!DNL Workfront Fusion]{#fusion-current}의 현재 문제
      ...
      + [Workfront Fusion: 실행 세부 정보가 처리 중으로 표시됨](known-issues-workfront-fusion/fusion-execution-details-display-processing.md)
