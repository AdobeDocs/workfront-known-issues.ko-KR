...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront]{#wf-current}의 현재 문제
      ...
      + [[!UICONTROL 보드]: [!UICONTROL 흡수] 열 검색은 비효율적입니다](known-issues-workfront/wf-boards-search-returns-no-results.md)
      + [[!UICONTROL 설정]: 목록 로드 속도 [!UICONTROL 설정]](known-issues-workfront/wf-setup-lists-load-slowly.md)
      ...
      + [사용자 지정 양식: 계산된 필드를 설정할 때 &quot;Whoops&quot; 오류가 발생합니다](known-issues-workfront/wf-custom-forms-error-with-calculated-field.md)
      ...
      + [타임시트: [!UICONTROL Tab] 키를 사용할 때 시간이 절약되지 않음](known-issues-workfront/wf-timesheets-hours-do-not-save-when-using-tab.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + [!DNL Workfront Proof]{#proof-current}의 현재 문제
      ...
      + [[!DNL Workfront Proof]: Workfront Proof: 폴더 보기에 증명이 표시되지 않음](known-issues-workfront-proof/proof-folder-views-not-displaying-proofs.md)
