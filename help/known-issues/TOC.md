...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront]{#wf-current}의 현재 문제
      ...
      + [문서: 자산을 다운로드하거나 미리볼 때 오류 화면](known-issues-workfront/wf-documents-error-screen-when-download-or-preview.md)
      ...
      + [업데이트: 업데이트의 이미지 미리 보기가 흐릿하게 표시됨](known-issues-workfront/wf-updates-images-blurred.md)
      ...
      + [[!UICONTROL 홈]: 새로운 [!UICONTROL 홈] 위젯 미리 보기에 오브젝트의 올바른 이름이 표시되지 않음](known-issues-workfront/wf-home-new-home-widget-preview-not-localized.md)
      ...
      + [증명: 증명이 미리 보기 환경에서 느리게 생성됨](known-issues-workfront/inactive/wf-proofs-in-preview-created-slowly.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + [!DNL Workfront Proof]{#proof-current}의 현재 문제
      ...
      + [증명: 증명이 미리 보기 환경에서 느리게 생성됨](known-issues-workfront-proof/proof-dependency-rules-multichoice.md)
