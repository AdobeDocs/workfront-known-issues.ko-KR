...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront]{#wf-current}의 현재 문제
      ...
      + [요청: 요청 페이지(“../submitted” URL)에서 대시보드에 액세스할 수 없음](known-issues-workfront/wf-requests-cannot-access-request-dashboard.md)
      + [통합: SSO를 사용할 때 사용자에게 잘못된 요청 오류가 발생함](known-issues-workfront/wf-outlook-wrong-request.md)
