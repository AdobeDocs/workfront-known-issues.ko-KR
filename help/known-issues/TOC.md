...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront]{#wf-current}의 현재 문제
      ...
      + [탐색: 개체를 고정할 수 없음](known-issues-workfront/wf-navigation-cannot-pin-objects.md)
      ...
      + [프로그램: [!UICONTROL 프로그램 소유자] 할당 시 문제 발생](known-issues-workfront/wf-programs-issues-assigning-program-manager.md)
      + [보고서: 문제 보고서에서 “이동” 옵션을 사용할 수 없음](known-issues-workfront/wf-reports-move-to-not-available-on-issue-report.md)
      + [문제: 작업 왼쪽 탐색 메뉴의 문제 수가 잘못됨](known-issues-workfront/wf-issues-incorrect-issue-count-on-left.md)
      ...
      + [타임시트: [!UICONTROL 일반 시간]에 시간을 입력할 수 없음](known-issues-workfront/wf-timesheets-general-time-disabled.md)
      + [목록: 팀을 검색할 때 [!UICONTROL 빠른 필터]가 결과를 반환하지 않음](known-issues-workfront/wf-lists-no-results-for-teams-in-quick-filter.md)
      + [탐색: 고정 항목이 제거된 후 페이지를 다시 고정할 수 없음](known-issues-workfront/wf-navigation-undo-pin-does-not-replace-pin.md)
      + [할당: 팀을 일괄 할당할 때 오류 발생](known-issues-workfront/wf-assignments-error-when-bulk-assigning-team.md)
      + [작업: 작업 헤더에 [!UICONTROL 전임 작업] 아이콘이 없음](known-issues-workfront/wf-tasks-predecessor-icon-missing-from-header.md)
      + [증명: 증명에 그룹을 추가해도 그룹의 모든 멤버가 추가되지 않음](known-issues-workfront/wf-proofs-group-members-not-added.md)
      + [작업 및 문제: 작업 또는 문제의 이름 또는 완료율을 편집할 수 없음](known-issues-workfront/wf-tasks-issues-cannot-edit-name-percent.md)
      + [레이아웃 템플릿: 레이아웃 템플릿에서 목록을 사용자 정의할 때 오류 발생](known-issues-workfront/wf-layout-templates-error-lists-users.md)
      + [증명: “새 증명 수신자“ 텍스트 상자가 너무 작음](known-issues-workfront/wf-proof-proof-share-recipient-box-too-small.md)
      + [증명: 증명을 자동 비교할 수 없음](known-issues-workfront/wf-proofs-cannot-auto-compare.md)
      + [문서: “[!UICONTROL 파일 업로드 실패]” 오류](known-issues-workfront/wf-documents-failed-to-upload-file.md)
      + [팀: 여러 팀을 할당하면 한 팀만 할당됨](known-issues-workfront/wf-teams-multiple-team-assignments.md)
      + [알림: 댓글에 언급되거나 포함되면 사용자가 알림을 받지 못함](known-issues-workfront/wf-notif-users-not-receiving-email-or-inapp-notif.md)
      + [타임시트: 타임시트에 댓글 추가 시 오류 발생](known-issues-workfront/wf-timesheets-permissions-error-when-adding-hours.md)
      + [증명:  [!DNL Workfront]에서 증명을 열 수 없음](known-issues-workfront/wf-cannot-open-proof-returns-to-doc-details.md)
      ...
      + [증명: 사용자가 증명을 닫을 때 이전 페이지로 돌아가지 않음](known-issues-workfront/wf-proofs-user-redirected-to-random-page-when-closing-proof.md)
      + [알림: 이메일 알림 설정에 액세스할 때 오류 발생](known-issues-workfront/wf-notifications-preview-errors-with-options.md)
      + [증명: [!UICONTROL 활성 증명 단계] 필드가 비어 있음](known-issues-workfront/wf-documents-stages-do-not-populate-on-proof.md)
      + [타임시트: [!UICONTROL Tab] 키를 사용할 때 시간이 저장되지 않음](known-issues-workfront/wf-timesheets-hours-do-not-save-when-using-tab.md)
      + [사용자 정의 양식: 왼쪽 패널의 요소 겹침](known-issues-workfront/wf-custom-forms-message-causes-element-overlap.md)
      + [목록: 인라인 편집 상태일 때 새 상태가 표시되지 않음](known-issues-workfront/wf-lists-inline-edit-does-not-show-new-status.md)
      + [보고서: [!UICONTROL Report Builder]에서 보고서를 만들고 편집할 때 문제 발생](known-issues-workfront/wf-reports-builder-degraded-performance.md)
      + [문서: [!UICONTROL 문서 세부 정보] 페이지에서 문서 승인을 사용할 수 없음](known-issues-workfront/wf-documents-approvals-not-in-document-details.md)
      + [보고서:  [!DNL Workfront]의 문제 보고서와 관련된 문제](known-issues-workfront/wf-reports-issues-with-issue-reports.md)
      + [할당 필드: 사용자 및 역할 할당 필드에 대해 임시로 업데이트된 이름](known-issues-workfront/wf-assignments-temp-updated-names.md)
      + [사용자 정의 양식: 설명 텍스트 필드에 도구 설명이 표시됨](known-issues-workfront/wf-custom-forms-descriptive-text-tooltip.md)
      ...
      + [타임시트: [!UICONTROL 죄송합니다.타임시트를 열 때 ] 오류 발생](known-issues-workfront/wf-timesheet-whoops-error-when-opening-timesheet.md)
      + [통합:  [!DNL Jira]에서  [!DNL Workfront for Jira] 를 열 때 오류 발생](known-issues-workfront/wf-error-when-opening-wf-for-jira-within-jira.md)
      + [타임시트: 시간을 입력할 때 “[!UICONTROL 누군가 이 프로젝트를 저장하려고 시도했습니다]” 오류 발생](known-issues-workfront/wf-timesheets-not-autosaving-due-to-error.md)
      + [대시보드: 오브젝트의 왼쪽 탐색에서 대시보드에 액세스할 수 없음](known-issues-workfront/wf-dashboards-cannot-open-from-left-nav.md)
      + [프로젝트, 작업 및 문제: 크기 조정된 [!UICONTROL 설명] 상자가 원래 크기로 돌아감](known-issues-workfront/wf-projects-description-field-size-snaps-back.md)
      + [프로젝트: 헤더에서 [!UICONTROL 프로젝트 소유자]를 제거하는 동안 오류 발생](known-issues-workfront/wf-projects-error-when-removing-project-owner.md)
      + [작업 및 문제: 작업 또는 문제를 만드는 중 의도치 않게 종료](known-issues-workfront/wf-inadvertent-exit-creating-tasks-or-issues.md)
      + [문제: 템플릿을 사용하여 문제를 프로젝트로 전환할 때 잘못된 오류 메시지가 표시됨](known-issues-workfront/wf-converting-issue-to-project-missing-error-message.md)
      + [대시보드: [!UICONTROL 업무 균형자] 링크가 대시보드에 잘못 표시됨](known-issues-workfront/wf-dashboard-workload-balancer-links-display-incorrectly.md)
      + [업데이트: 업데이트 스트림에서 사용자 카드를 닫을 수 없음](known-issues-workfront/wf-updates-cant-close-user-card.md)
      + [보고서: 보고서에서 작업을 인라인 편집할 때 “[!UICONTROL 반복에 추가]” 및 “[!UICONTROL Kanban 보드에 추가]” 옵션을 사용할 수 없음](known-issues-workfront/wf-reports-no-option-to-add-to-kanban.md)
      + [요청: 요청 목록에서 첫 번째 페이지 이후의 페이지를 열 수 없음](known-issues-workfront/wf-requests-cannot-open-second-page-of-requests-list.md)
      + [사용자 정의 양식: 요청을 프로젝트로 전환할 때 섹션 구분에 의해 숨겨진 필드의 데이터가 유지되지 않음](known-issues-workfront/wf-requests-cust-form-data-hidden-not-converted.md)
      + [프로젝트: 프로젝트의 날짜를 변경할 때 “[!UICONTROL 타임라인 계획 수립 모드]” 오류 발생](known-issues-workfront/wf-projects-error-when-using-timeline-planning.md)
      + [요청: 요청을 만들 때 팀 할당이 새 요청에 표시되지 않음](known-issues-workfront/wf-teams-assignment-lost-when-creating-requests.md)
      ...
      + [사용자 정의 양식: 사용자 정의 양식 빌더의 사용자 정의 필드에서 지침을 제거할 수 없음](known-issues-workfront/wf-cust-form-cannot-remove-instructions-from-field.md)
      + [알림: 댓글에 언급되면 사용자는 이메일 알림을 받지 않음](known-issues-workfront/wf-notif-users-not-receive-email-when-mentioned.md)
      + [타임시트: 댓글이 저장되지 않음](known-issues-workfront/resolved-issues-wf/wf-timesheets-comments-not-save.md)
      + [타임시트: 타임시트에 시간을 추가할 때 “[!UICONTROL 청구된 시간이 이미 있음]” 오류 발생](known-issues-workfront/wf-timesheets-billed-hours-already-exist.md)
      + [작업 및 문제: 작업 또는 문제의 헤더에서 [!UICONTROL 계획된 완료 일자]를 변경할 때 오류 발생](known-issues-workfront/resolved-issues-wf/wf-500-error-planned-completion.md)
      + [타임시트: [!UICONTROL 완료] 또는 [!UICONTROL 중단] 상태인 프로젝트에 시간을 추가하는 것과 관련된 문제](known-issues-workfront/wf-timesheets-add-hours-to-complete-dead.md)
      + [레이아웃 템플릿: 사용자에게 할당 가능한 레이아웃 템플릿을 사용할 수 없음](known-issues-workfront/wf-layout-templates-not-available-to-assign.md)
      + [보고서: 활용성 보고서를 내보낼 수 없음](known-issues-workfront/wf-reports-cannot-export-utilization-report.md)
      + [타임시트: 타임시트에 변경 내용을 자동 저장할 때 “최근 변경 내용이 저장되지 않음” 오류 발생](known-issues-workfront/wf-timesheets-recent-changes-not-saved-error.md)
      + [타임시트: 시간이 자동 저장되지 않음](known-issues-workfront/wf-timesheets-hours-do-not-autosave.md)
      + [사용자 정의 양식: 문제를 프로젝트로 전환할 때 섹션 구분에 의해 숨겨진 필드의 데이터가 유지되지 않음](known-issues-workfront/wf-custom-forms-data-lost-hidden-section-break.md)
      + [보드: 보드 카드의 연결된 항목에 대한 [!UICONTROL 상태] 변경 관련 문제](known-issues-workfront/resolved-issues-wf/wf-boards-issues-status-change.md)
      + [대시보드: 대시보드에 표시된 보고서 차트는 보고서에서 볼 때와 다른 색상을 사용함](known-issues-workfront/wf-dashboard-reports-wrong-color.md)
      + [사용자 정의 양식: [!UICONTROL 설명 텍스트] 필드에 대한 잘못된 문자 제한으로 인해 사용자 정의 양식을 편집할 수 없음](known-issues-workfront/wf-custom-form-incorrect-character-limit.md)
      + [설정: 새 상태를 만들 수 없음](known-issues-workfront/resolved-issues-wf/wf-cannot-create-new-status.md)
      + [사용자 정의 양식: [!UICONTROL 설명 텍스트] 필드로 인해 사용자 정의 양식을 편집할 수 없음](known-issues-workfront/wf-cust-form-descr-text-label-error.md)
      + [[!DNL Search]:  [!DNL Workfront]에서 [!UICONTROL 검색]을 사용할 때 오류 발생](known-issues-workfront/wf-search-error-using-search.md)
      + [문제: 문제에 대한 시간을 승인하거나 거부할 수 없음](known-issues-workfront/wf-issues-cannot-approve-hours.md)
      + [보고서: 보고서가 일정대로 전송되지 않음](known-issues-workfront/wf-reports-not-sent-as-scheduled.md)
      + [보고서: 스크롤할 때 매트릭스 보고서가 잘못 표시됨](known-issues-workfront/wf-reports-matrix-display-incorrectly.md)
      + [애자일: 애자일 보드에서 카드를 이동할 때 문제 발생](known-issues-workfront/wf-agile-issues-moving-cards.md)
      + [용어(독일어): 브라우저 언어가 독일어로 설정되어 있을 때 일부 영역에서 용어가 잘못됨](known-issues-workfront/wf-terminology-in-german.md)
      + [업데이트: 사용자를 태그 지정한 다음 다른 위치로 이동하면 태그 지정된 사용자가 제거됨](known-issues-workfront/resolved-issues-wf/wf-updates-tag-users-navigate-away-untags.md)
      + [검색: 참조 번호로 프로젝트를 검색할 수 없음](known-issues-workfront/wf-search-cannot-search-proj-by-ref-number.md)
   ...
   + [!DNL Adobe Workfront]{#wf-resolved}의 해결된 문제
      + [보고서: 새 [!UICONTROL 보고 캔버스]가 로드되지 않음](known-issues-workfront/resolved-issues-wf/wf-reports-new-canvas-does-not-load.md)
      + [캘린더: 캘린더에 항목을 추가할 때 버튼이 잘못 표시됨](known-issues-workfront/resolved-issues-wf/wf-calendar-button-displays-incorrectly.md)
      + [타임시트: 타임시트를 만드는 중 오류 발생](known-issues-workfront/resolved-issues-wf/wf-timesheets-issues-creating-timesheets.md)
      + [템플릿: 템플릿을 첨부할 때 작업을 선택 해제할 수 없음](known-issues-workfront/resolved-issues-wf/wf-templ-cannot-deselect-tasks.md)
      + [보고서: 예약된 보고서가 모든 수신자에게 전송되지 않음](known-issues-workfront/resolved-issues-wf/wf-reports-scheduled-not-sent-to-all.md)
      + [[!UICONTROL 홈]: [!UICONTROL 홈 작업] 목록에서 항목을 열 때 오류 발생](known-issues-workfront/resolved-issues-wf/wf-home-error-opening-item-work-list.md)
      + [타임시트: 타임시트에 표시되는 시간이 타임시트 목록과 다름](known-issues-workfront/resolved-issues-wf/wf-timesheets-hours-different-in-list.md)
      + [요청: 템플릿을 사용하여 프로젝트로 전환되는 요청이 템플릿의 그룹이 아니라 요청 대기열의 그룹을 표시함](known-issues-workfront/resolved-issues-wf/wf-requests-converted-shows-group-from-queue.md)
      + [타임시트: 타임시트 시간이 제대로 저장되지 않음](known-issues-workfront/resolved-issues-wf/wf-timesheets-hours-not-autosaving-correctly.md)
      + [작업: 작업 기간을 인라인 편집할 때 [!UICONTROL 경과] 시간을 선택할 수 없음](known-issues-workfront/resolved-issues-wf/wf-tasks-cannot-select-elapsed-time.md)
      + [업데이트: [!UICONTROL 내 업데이트] 페이지가 비어 있음](known-issues-workfront/resolved-issues-wf/wf-updates-my-updates-blank.md)
      + [사용자: 사용자를 복사할 때 “[!UICONTROL SAML 2.0 인증만 허용]” 설정이 표시되지 않음](known-issues-workfront/resolved-issues-wf/wf-users-only-allow-saml-setting-missing.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + [!DNL Workfront Proof]{#proof-current}의 현재 문제
      ...
      + [[!DNL Workfront Proof]: 폴더 보기에 증명이 표시되지 않음](known-issues-workfront-proof/proof-folder-views-not-displaying-proofs.md)
      + [[!DNL Workfront Proof]: 1.5GB를 초과하는 파일에 대한 증명을 만들 수 없음](known-issues-workfront-proof/proof-cannot-proof-files-over-1-5gb.md)
      + [[!DNL Workfront Proof]: [!UICONTROL 새 증명] 페이지에 텍스트 필드가 누락됨](known-issues-workfront-proof/proof-new-page-missing-text-fields.md)
      + [[!DNL Workfront Proof]: 이메일 알림이 지연됨](known-issues-workfront-proof/proof-delays-receiving-email-notifications.md)
      + [[!DNL Workfront Proof]: 요청자 및 검토자 수가 조직의 라이선스 수에 포함됨](known-issues-workfront-proof/proof-requestor-reviewer-count-as-licenses.md)
      ...
      + [[!DNL Workfront Proof]: 증명에 추가된 사용자에게는 “[!UICONTROL 보기]” 액세스만 허용됨](known-issues-workfront-proof/proof-added-users-have-only-view.md)
      ...
      + [홈 작업 목록에 부정확한 증명 승인 기한이 표시됨](known-issues-workfront-proof/inaccurate-proof-approval-deadline-displayed.md)
...
+ [!DNL Adobe Workfront Fusion] {#fusion}
   ...
   + [!DNL Workfront Fusion]{#fusion-current}의 현재 문제
      ...
      + [[!DNL Workfront Fusion]: [!DNL Adobe PDF Services] > [!UICONTROL 텍스트 추출] 모듈이 텍스트를 생성하지 않음](known-issues-workfront-fusion/fusion-pdf-extract-text.md)
      + [[!DNL Workfront Fusion]: “연결 확인 실패” 오류](known-issues-workfront-fusion/fusion-401-error-must-reauthenicate-connection.md)
      + [[!DNL Workfront Fusion]: 시나리오를 만들거나 편집할 때 모듈이 로드되지 않음](known-issues-workfront-fusion/fusion-module-does-not-load.md)
      ...
      + [[!DNL Workfront Fusion]: Fusion의 MS Dynamics 모듈에 연결할 수 없음](known-issues-workfront-fusion/fusion-unable-to-connect-to-ms-dynamics-module.md)
