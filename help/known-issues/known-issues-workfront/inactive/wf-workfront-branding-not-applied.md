...
>[!IMPORTANT]
>
>조직이 Adobe Admin Console, Adobe Unified Shell 또는 Adobe IMS(ID 관리 시스템)로 마이그레이션된 경우 브랜딩을 사용할 수 없습니다.

Adobe Admin Console, Adobe Unified Shell 또는 Adobe IMS(ID 관리 시스템)로 마이그레이션한 조직에서는 브랜딩을 사용할 수 없습니다. 브랜딩을 사용하려고 할 때 이러한 조직 중 하나의 사용자에게 다음 중 하나가 표시될 수 있습니다.
