...
사용자가 업데이트에서 태그된 경우 누가 자신에게 태그를 지정했는지 확인할 수 없습니다. 이 문제는 &quot;다른 회사의 직원들은 다음 위치의 사용자만 볼 수 있습니다...&quot; 설정이 있을 때 발생합니다. 이 &quot;해당 회사&quot;로 설정되어 있습니다.
...
+++**2024년 4월 18일 금요일 유지 관리 업데이트**

### 2024년 4월 18일 금요일 유지 관리 업데이트

#### 애자일

**칸반 카드에 사용자 정의 필드가 표시되지 않음**

사용자가 사용자 정의 필드를 포함하도록 구성된 칸반 보드를 조회할 때 해당 사용자 정의 필드가 표시되지 않을 수 있습니다.
...
+++**2024년 1월 30일 수요일 유지 관리 업데이트 (핫픽스)**
