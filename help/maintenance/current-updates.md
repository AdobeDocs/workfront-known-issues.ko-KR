...
+++**2026년 2월 22~28일의 유지 보수 업데이트 주**

### 2026년 2월 22~28일의 유지 보수 업데이트 주

#### 요청

**요청을 작성할 때 문서를 업로드할 수 없음**
...
**계산된 필드에 관리자가 아닌 사용자의 데이터가 표시되지 않음**
...
**증명에서 언급된 내용이 언급 위젯에 표시되지 않음**

사용자가 증명에 대한 댓글에 언급되는 경우 해당 언급은 홈의 언급 위젯에 포함되지 않습니다.

#### 로그인

**로그인 후 Workfront이 로드되지 않음**

사용자가 Workfront에 로그인할 때 Workfront이 로드되지 않습니다. 페이지를 새로 고치면 Workfront이 예상대로 로드됩니다.

#### 보고

Workfront Planning 필드가 캔버스 대시보드 Report Builder에 표시되지 않음

사용자가 캔버스 대시보드에서 빌더를 사용하고 Workfront Planning의 필드를 참조하려고 할 때 해당 필드가 빌더 내에 표시되지 않습니다.
...
사용자가 새 요청 경험에서 요청 목록을 볼 때 일부 요청의 제목 열에 &quot;제목 없음&quot;이 표시됩니다.

사용자가 이러한 요청 중 하나를 열면 해당 요청에 제목이 있음을 알 수 있습니다.
