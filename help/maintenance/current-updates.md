...
+++**[!DNL Adobe Workfront Fusion]유지 관리 업데이트(핫픽스): 2023년 1월 12일**
...
+++**유지 관리 업데이트(핫픽스): 2023년 1월 12일**

**&quot;[!UICONTROL 우프]&quot; 계산된 필드를 설정할 때 오류가 발생했습니다**
...
사용자가 다른 사용자의 액세스 수준을 변경하려고 하면 액세스 수준이 회색으로 표시되어 사용자가 변경할 수 없습니다. 이 문제는 변경을 시도하는 사용자가 시스템 관리자인 경우에도 발생합니다.
