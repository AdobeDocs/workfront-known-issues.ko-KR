...
2024년 이전 유지 보수 업데이트는 다음을 참조하십시오. [이전 유지 보수 업데이트](#previous-maintenance-updates)

## 2024년 3월 업데이트

+++**(예정) 2024년 3월 21일 금요일 유지 보수 업데이트**
...
**@으로 사용자 태그 지정은 효과가 없음**

사용자가 댓글에서 @으로 다른 사용자를 태그 지정할 때 해당 사용자는 태그 지정된 사용자 영역에 추가되지 않으며 댓글에 대한 알림을 받지 못합니다.

이 수정 사항은 새 댓글 달기 경험에만 적용됩니다.
