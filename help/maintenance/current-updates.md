...
+++**2024년 10월 3일 금요일 유지 보수 업데이트**

### 2024년 10월 3일 유지 보수 업데이트

#### 보드

**보관된 연결된 카드가 동기화되지 않음**

성능 문제를 해결하기 위해 보관된 연결된 카드가 더 이상 동기화되지 않습니다. Workfront 작업 또는 문제에 대한 변경 사항은 보관된 카드에 반영되지 않습니다. 카드를 복원하면 다시 동기화됩니다.

#### 사용자 정의 양식

**사용자 정의 양식의 표시 형식 전환 오류**
...
**기여자 사용자가 전자 메일 알림을 받지 못함**

참여자 라이선스가 있는 사용자에게 알림 이메일이 수신되지 않습니다. 이 문제는 즉시 알림 이메일과 일일 요약 이메일 모두에 영향을 미칠 수 있습니다.

#### 증명

증명에 SSO를 사용할 때 **전자 서명을 추가할 수 없음**

SSO를 사용하여 Proof에 로그인할 때 사용자가 전자 서명을 요구하도록 증명을 설정할 수 없습니다.
