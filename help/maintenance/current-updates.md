...
**완료된 프로젝트에서 사용자 지정 데이터를 업데이트할 수 없음**
...
사용자가 완료 상태의 프로젝트에 문제를 추가하려고 할 때 문제를 추가할 수 없습니다. 문제 추가 및 편집 옵션이 활성화된 경우에도 이 문제가 발생할 수 있습니다
...
문서 목록에 나열된 날짜에는 최신 버전이 생성된 날짜 대신 문서의 첫 번째 버전이 생성된 날짜가 표시됩니다.

### 타임시트

사용자가 제출됨 또는 닫힘 상태의 타임시트에 시간을 기록하려고 하면 시간을 기록할 수 없습니다.
