...
>[!NOTE]
>
>Workfront를 포함한 모든 Adobe 제품의 유지 보수 중단에 대한 자세한 내용은 [Adobe 상태 페이지](https://status.adobe.com/)를 참조하십시오.
...
+++**2024년 10월 10일 금요일 유지 보수 업데이트**

### 2024년 10월 10일 금요일 유지 보수 업데이트

#### 보드

**카드를 이동하거나 사용자를 할당할 때 오류 발생**
...
&quot;이 보드를 로드하는 도중 문제가 발생했습니다. 페이지를 새로 고쳐 다시 시도하거나 문제가 지속되면 아래 오류 ID로 지원 센터에 문의하십시오.&quot;

#### 홈

**&quot;완료로 표시&quot;를 선택하면 내 문제 위젯에 대한 요약 창이 닫힙니다**

내 문제 위젯을 통해 열린 문제의 요약 창에서 [완료로 표시] 버튼을 사용하면 요약 창이 예기치 않게 닫힙니다.

**레이아웃 템플릿 위젯 설정에서 열을 추가하지 못함**

레이아웃 템플릿 위젯 설정을 통해 위젯에 추가할 필드를 선택할 때 필드를 선택할 수 있지만 해당 열이 위젯에 표시되지 않습니다.
...
작업에 경비를 추가한 후에는 API를 입력했는데도 불구하고 작업 정보에 경비가 표시되지 않습니다.

+++

+++**2024년 10월 3일 유지 보수 업데이트**
