...
+++**(예정) 2024년 3월 14일 금요일 유지 보수 업데이트**
...
**링크된 문서에서 생성된 증명에는 증명 템플릿이 적용되지 않았습니다.**
...
**사용자를 만들 때 더 낮은 액세스 수준을 사용할 수 없음**
...
+++**2024년 3월 7일 금요일 유지 보수 업데이트**

### 2024년 3월 7일 유지 보수 업데이트

#### 보드

**보드에 작업을 추가할 때 400 오류 발생**
...
사용자가 내 작업 위젯에서 작업을 인라인 편집하려고 할 때 다음과 같은 오류가 표시됩니다.
...
**Workfront Proof > 증명 모듈 시청 시간 제한**
