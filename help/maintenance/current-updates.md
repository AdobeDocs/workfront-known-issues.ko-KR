...
**[!UICONTROL 스토리 포인트] 작업 및 문제 목록 및 보고서에 추가된 필드**

_보고서_

다음 [!UICONTROL 스토리 포인트] 이제 작업을 위한 목록 및 보고서에 필드를 추가할 수 있습니다. 이는 편집 가능한 자유 형식 필드이며, 계획된 시간이나 팀 할당에 연결되지 않습니다.
...
다음 [!UICONTROL 보드] 이제 아이콘이 [!UICONTROL 기본 메뉴] 레이아웃 템플릿이 없는 사용자용. 보드는 생성되는 모든 새 레이아웃 템플릿에 대해 기본적으로 메인 메뉴에도 포함됩니다. 기존 레이아웃 템플릿은 변경되지 않았습니다.
