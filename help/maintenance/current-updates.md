...
**증표에 주석을 달 때 폴리라인 도구를 사용할 수 없습니다**
...
**목표 및 주석 달기 베타 경험의 문제를 업데이트에서 제거할 때 이미지를 초안으로 유지합니다**

>[!NOTE]
>
>이 기능은 2023년 4월 19일 미리 보기에 출시되었으며 2023년 4월 20일 프로덕션에 릴리스되었습니다.

_업데이트_

이제 이미지를 첨부한 메시지를 작성하는 도중에 업데이트 페이지에서 멀리 이동하면 다시 탐색할 때 메시지와 이미지가 유지됩니다. 이 업데이트 전에 제출되지 않은 주석이 보존되었지만 이미지가 삭제되었습니다. 이 기능은 업데이트 섹션에서 목표 및 주석 베타 경험을 활성화할 때 발생할 수 있는 문제에 대해 설명합니다.

**업데이트 섹션에서 실시간 업데이트 및 삭제된 주석**
...
이제 누군가 댓글이나 응답을 추가하거나 업데이트 영역에서 댓글을 삭제하면 새 댓글이 표시되거나 댓글이 실시간으로 제거되었다는 메시지가 지체 없이 표시됩니다. 이 기능은 업데이트 섹션에서 목표 및 주석 베타 경험을 활성화할 때 발생할 수 있는 문제에 대해 설명합니다.

**변경 기록 없이 시스템에 의해 변경된 액세스 수준**
