...
+++**2024년 9월 26일 금요일 유지 보수 업데이트**

### 2024년 9월 26일 금요일 유지 보수 업데이트

#### 애자일

스크럼 팀을 할당할 때 **반복에 추가 옵션이 두 번 나열됨**
...
사용자 정의 양식의 계산된 필드에 대한 계산 편집기에서 이제 객체의 필드 목록이 200개의 항목으로 제한되어 시스템 성능을 향상시킬 수 있습니다. 필드 이름을 알고 있는 경우 목록을 스크롤하지 않고 자동 완성 옵션을 사용하여 검색할 수 있습니다.
