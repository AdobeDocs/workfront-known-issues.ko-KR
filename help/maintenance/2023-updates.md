...
+++**[!DNL Adobe Workfront Fusion]2023년 12월 21일 금요일 유지 관리 업데이트**

모듈 필드를 여는 데 시간이 너무 오래 소요됨

_[!DNL Workfront Fusion]_

<!--no article-->

사용자가 모듈을 구성 중이고 모듈에 연결된 계정의 데이터가 필요한 경우(예: 레코드 선택) 모듈이 데이터를 가져올 수 없으며 데이터에 대한 요청 시간이 초과됩니다.

+++

+++**2023년 12월 14일 금요일 유지 관리 업데이트**

**승인 보류 중인 교정쇄가 보고서에 표시되지 않음**

_교정쇄_

사용자가 보류 중인 교정쇄 승인에 대한 보고서를 볼 때 일부 보류 중인 승인이 보고서에 표시되지 않습니다.
+++

+++**2023년 12월 7일 금요일 유지 관리 업데이트**
...
사용자가 교정쇄를 생성하려는 경우 교정쇄가 만들어지지 않고 사용자에게 다음과 같은 오류 메시지가 표시됩니다.
...
+++**2023년 11월 3일 토요일 유지 관리 업데이트 (핫픽스)**
...
**웹 뷰어에서 인터랙티브 교정쇄를 볼 수 없음**

_교정쇄_

사용자가 웹 교정쇄 뷰어에서 교정쇄를 보려고 하면 교정쇄가 표시되지 않고 다음 오류가 표시됩니다.
...
사용자가 교정쇄의 새 버전을 만들려고 하면 새 버전이 만들어지지 않고 사용자에게 다음과 같은 오류 메시지가 표시됩니다.
...
**교정쇄에 대한 댓글을 다는 경우의 추가, 빈 댓글**

_교정쇄_

사용자가 교정쇄에 대한 댓글을 달면 교정쇄에 비어 있는 다른 댓글이 생성됩니다.

이는 비디오 교정쇄에서 보고되었습니다.

**[!UICONTROL 교정 활동] 탭이 열리지 않음**

_교정쇄_

사용자가 교정쇄를 조회하는 동안 [!UICONTROL 교정 활동] 탭을 클릭하면 해당 탭은 사용자에게 [!UICONTROL 교정쇄 세부 정보] 탭을 반환합니다.
...
**교정쇄가 채도가 낮거나 잘린 것으로 표시됨**

_교정쇄_

URL에서 교정쇄 생성 시 다음과 같은 문제가 보고되었습니다.

* 교정쇄가 바래거나 채도가 낮은 것으로 표시됩니다.
* 교정쇄가 잘립니다.

교정쇄가 정확하게 나타나지 않으므로 교정쇄 결정이 어려울 수 있습니다.

**교정쇄 생성 시 시간이 오래 걸림**

_교정쇄_

사용자가 교정쇄를 생성하려는 경우 교정쇄를 생성하는 데 시간이 오래 걸립니다. 교정쇄 생성에 며칠이 걸릴 수 있습니다.

+++

+++**2023년 9월 14일 금요일 유지 관리 업데이트**
...
사용자가 교정쇄 뷰어에서 교정쇄를 보고 목록이나 글머리 기호에 있는 텍스트를 선택하려고 하면 텍스트 선택 도구가 효과가 없으며 텍스트를 선택할 수 없습니다.

**새 교정쇄 버전 생성 시 교정쇄의 모든 버전이 삭제됨**

_교정쇄_

사용자가 문서에서 교정쇄를 만들면 교정쇄가 생성됩니다. 그러나 사용자가 다른 버전의 교정쇄를 만들면 이전 버전과 새 버전이 모두 삭제됩니다. 원본 문서에는 [!UICONTROL 교정쇄 만들기] 옵션이 있으며, 교정쇄 버전은 [!DNL Workfront]의 [!UICONTROL 교정쇄] 영역에 있는 [!UICONTROL 휴지통] 영역에서 찾을 수 있습니다.
...
**“[!UICONTROL 교정쇄 이메일 알림 비활성화]” 설정이 부정확하게 표시됨**

_교정쇄_

사용자가 [!DNL Workfront]에서 교정쇄 설정을 조회할 때 “[!UICONTROL 교정쇄 이메일 알림 비활성화]” 확인란이 올바른 현재 설정을 정확하게 표시하지 않습니다. 교정쇄 이메일 알림이 비활성화되었음을 나타내는 확인란을 선택하면 알림이 실제로 활성화됩니다. 그 반대의 경우도 마찬가지입니다.

**교정쇄 마크업을 조정할 수 없음**

_교정쇄_

사용자가 교정쇄 뷰어에서 댓글을 작성하고 교정쇄에 마크업을 표시한 다음 클릭하면 사용자가 더 이상 해당 마크업을 조정할 수 없습니다.
...
+++**2023년 7월 20일 금요일 유지 관리 업데이트**

이 업데이트에는 사소하거나 눈에 잘 띄지 않는 버그 수정만 포함됩니다. [!DNL Workfront] 지원 센터에서는 제출된 문제가 해결되면 알려 드립니다.

+++

+++**2023년 7월 13일 금요일 유지 관리 업데이트**
...
**잠긴 교정쇄 승인이 작업 목록에 계속 표시됨**

_교정쇄_

기한이 지났고 잠겨 있는 교정쇄 승인이 기한이 지났음에도 불구하고 목록에서 삭제되지 않고 승인자의 홈 작업 목록에 계속 표시됩니다.
...
+++**2023년 6월 29일 금요일 유지 관리 업데이트**

이 업데이트에는 사소하거나 눈에 잘 띄지 않는 버그 수정만 포함됩니다. [!DNL Workfront] 지원 센터에서는 제출된 문제가 해결되면 알려 드립니다.

+++

+++**2023년 6월 22일 금요일 유지 관리 업데이트**
...
+++**2023년 6월 15일 금요일 유지 관리 업데이트**

이 업데이트에는 사소하거나 눈에 잘 띄지 않는 버그 수정만 포함됩니다. [!DNL Workfront] 지원 센터에서는 제출된 문제가 해결되면 알려 드립니다.

+++

+++**2023년 6월 8일 금요일 유지 관리 업데이트**

이 업데이트에는 사소하거나 눈에 잘 띄지 않는 버그 수정만 포함됩니다. [!DNL Workfront] 지원 센터에서는 제출된 문제가 해결되면 알려 드립니다.

+++

+++**[!DNL Adobe Workfront Fusion]2023년 6월 8일 금요일 유지 관리 업데이트**
...
+++**2023년 5월 25일 금요일 유지 관리 업데이트**

**[!UICONTROL 카드를 편집할 때 칸반] 보드가 비어 있음**

_애자일_

사용자가 [!UICONTROL 칸반] 보드에서 카드에 대한 무언가를 변경하면 변경 내용을 새로 고치는 대신 [!UICONTROL 칸반] 보드가 공백이 됩니다. 사용자가 페이지를 수동으로 새로 고치면 [!UICONTROL 칸반] 보드가 복구되면서 올바른 변경 사항을 표시합니다.
...
+++**2023년 5월 18일 금요일 유지 관리 업데이트**

**사용자 정의 필드로 정렬할 때 보고서가 올바르게 정렬되지 않음**

_보고서_
사용자가 작업 보고서를 실행할 때 로드 중에는 보고서가 올바르게 정렬되는 것으로 보이지만 로드를 마치면 보고서가 올바르게 정렬되지 않은 것으로 표시됩니다.
...
+++**2023년 5월 11일 금요일 유지 관리 업데이트**

**교정쇄를 볼 때 교정쇄 버전을 전환할 수 없음**

_교정쇄_

사용자가 [!UICONTROL 교정쇄 뷰어]에서 교정쇄를 보고 다른 버전으로 전환할 때 해당 버전 드롭다운이 비활성화되고 사용자는 보고 있던 원본 버전이나 다른 버전의 교정쇄으로 다시 전환할 수 없습니다.
...
+++**2023년 4월 27일 금요일 유지 관리 업데이트**

**[!UICONTROL 교정쇄 뷰어]**&#x200B;에서 교정쇄 사이를 전환할 수 없음

_교정쇄_

사용자가 [!UICONTROL 교정쇄 뷰어]에서 교정쇄를 조회하는 동안 다른 교정쇄으로 전환하려고 할 때 교정쇄 전환 버튼이 응답하지 않습니다. 사용자는 보고 있던 원래 교정쇄으로 다시 돌아오거나 다른 교정쇄으로 전환할 수 없습니다.
...
**교정쇄에 대한 댓글을 달 때 폴리라인 도구를 사용할 수 없음**

_교정쇄_

사용자가 교정쇄 뷰어에서 교정쇄를 보고 폴리라인 도구를 사용하여 댓글을 작성하려고 할 때 도구가 해당 교정쇄를 표시하지 않습니다.

**텍스트 옵션 상자에 “textAnnotations”가 표시됨**

_교정쇄_

사용자가 교정쇄를 조회하고 댓글을 추가하기 시작하면서 텍스트 도구를 열면 도구의 옵션 옆에 “textAnnotation”이라는 단어가 나타납니다. 텍스트 도구는 여전히 예상대로 작동하며 댓글이 게시된 후 “textAnnotation”은 사라집니다.
...
+++**2023년 4월 6일 금요일 유지 관리 업데이트**

**사용자가 교정쇄에 추가될 때 드롭다운이 열리지 않음**

_교정쇄_

사용자가 [!UICONTROL 교정쇄 뷰어]의 교정쇄에 다른 사용자를 추가할 때 “[!UICONTROL 교정 역할]” 및 “[!UICONTROL 이메일 경고]” 드롭다운을 열 수 없습니다. 해당 사용자는 교정 역할 또는 이메일 경고를 할당할 수 없습니다. 이 문제는 댓글을 통해 사용자를 추가하거나 해당 사용자와 교정쇄를 공유할 때 발생할 수 있습니다.

+++

## 2023년 3월 업데이트

+++**2023년 3월 30일 금요일 유지 관리 업데이트**
...
[!UICONTROL 데스크탑 교정쇄 뷰어]에서의 댓글 문제를 해결하기 위해 데스크탑 교정쇄 뷰어의 새로운 버전이 배포되었습니다.
...
사용자가 교정쇄를 공유하고 사용자 정의 메시지를 추가하면 해당 사용자 정의 메시지가 수신자에게 전송되는 알림 이메일에 표시되지 않습니다. 제목은 교정쇄 이름이며 이메일에는 해당 메시지가 표시되지 않습니다.

+++

+++**2023년 3월 9일 금요일 유지 관리 업데이트**
...
데스크탑 교정쇄 뷰어의 작동 중단 문제를 해결하기 위해 데스크탑 교정쇄 뷰어의 새로운 버전이 배포되었습니다. 이미 데스크탑 교정쇄 뷰어를 설치한 사용자는 이 업데이트를 자동으로 받게 됩니다.

사용자는 최신 버전을 수동으로 다운로드할 수도 있습니다. 자세한 내용은 [데스크탑 교정쇄 뷰어 설치](https://experienceleague.adobe.com/docs/workfront/using/review-and-approve-work/proofing/use-the-desktop-proofing-viewer/installing-desktop-proofing-viewer.html?lang=ko-KR)를 참조하십시오.
...
+++**2023년 1월 12일 금요일 유지 관리 업데이트 (핫픽스)**
