---
title: 2025년 Workfront 유지 보수 업데이트
...
# 2025년 유지 보수 업데이트 [!DNL Workfront]개
...
+++**2025년 12월 21~27일의 Workfront Planning 유지 관리 업데이트 주**
...
**작업을 만들 때 사용자 역할을 선택할 수 없습니다**

사용자가 작업을 생성하고 사용자 역할을 할당하려고 할 때 역할 할당 옵션이 없으며 사용자 역할을 할당할 수 없습니다.

+++

+++**2025년 12월 14~20일의 Workfront Planning 유지 관리 업데이트 주**
...
사용자가 요청을 만들 때 해당 요청은 권한을 상속하지 않습니다. 즉, 사용자가 요청에 액세스하지 못할 수 있습니다.
