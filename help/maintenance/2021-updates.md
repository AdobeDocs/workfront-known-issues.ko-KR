...
[!DNL Workfront Proof]에 로그인된 사용자가 폴더를 볼 때 폴더가 비어 있습니다. 나중에 다시 확인하면 교정쇄가 표시됩니다.

+++

+++**2021년 12월 16일 금요일 유지 관리 업데이트**
...
[!UICONTROL 업무 균형자]의 사용자가 [!UICONTROL 할당:Role ID] 필드를 사용하여 필터를 만들 때 [!UICONTROL 미할당 작업] 영역이 로드되지 않습니다.
...
+++**2021년 12월 10일 토요일 유지 관리 업데이트 (핫픽스)**
...
**칸반 보드의 열이 너무 넓고 조정할 수 없음**

_애자일_

사용자가 열이 여러 개 있는 칸반 보드를 볼 때 열이 너무 넓어서 카드를 보거나 맨 오른쪽 열로 이동하려면 스크롤해야 합니다. 열 너비를 조정할 수 없으므로 모든 열이 화면에 동시에 표시되도록 열을 더 작게 만들 수 없습니다.
...
+++**2021년 10월 21일 금요일 유지 관리 업데이트 (핫픽스)**
...
+++**2021년 10월 19일 수요일 유지 관리 업데이트 (핫픽스)**
...
“[!UICONTROL 액세스 거부됨: 죄송합니다. 문제가 발생했습니다. 문제점과 수정 방법을 확인하려면 [!DNL Workfront]로 연락하십시오.]”
...
“[!UICONTROL 다시 시도해 보십시오. 기본 키 값이 “(그룹의 ID)”인 그룹을 찾을 수 없습니다.]”
...
+++**2021년 9월 10일 토요일 유지 관리 업데이트 (핫픽스)**
...
사용자가 교정쇄를 인쇄하기 위해 인쇄 요약을 열면 헤더가 표시되지만 요약 내용이 비어 있습니다.
...
+++**2021년 8월 6일 토요일 유지 관리 업데이트 (핫픽스)**
...
**새 교정쇄를 만들 때 교정쇄 설정을 변경할 수 없음**

_[!DNL Workfront Proof]_

사용자가 새 교정쇄를 만들 때 설정을 변경하려고 하면 설정이 이전 설정으로 되돌아갑니다.
...
+++**2021년 7월 29일 금요일 유지 관리 업데이트 (핫픽스)**

**새 교정쇄 또는 새 교정쇄 버전을 업로드할 수 없음**

_[!DNL Workfront Proof]_

사용자가 클래식 [!DNL Workfront] 경험에서 새 교정쇄 또는 새 교정쇄 버전을 업로드하려고 하면 새 교정쇄 또는 새 버전 페이지가 비어 있고 교정쇄 또는 버전을 업로드할 수 없습니다.

+++

+++**2021년 7월 29일 금요일 유지 관리 업데이트**

**[!UICONTROL 교정 활동] 및 [!UICONTROL 교정쇄 뷰어 설정] 페이지가 항상 사용 가능**

_[!DNL Workfront Proof]_

이제 사용자가 [!UICONTROL 교정 활동] 및 [!UICONTROL 교정쇄 뷰어] 설정 페이지를 업데이트할 권한이 없더라도 해당 페이지가 항상 표시됩니다.

이전에는 사용자 정의 교정 권한 프로필이 있는 사용자가 문서로 이동할 때 왼쪽의 [!UICONTROL 교정 활동] 및 [!UICONTROL 교정쇄 뷰어 설정] 페이지가 표시되지 않는 경우도 있었습니다.
...
+++**2021년 7월 22일 금요일 유지 관리 업데이트**

**새 교정쇄 버전의 이름이 잘림**

_[!DNL Workfront Proof]_

[!DNL Adobe Workfront Classic]의 사용자가 파일 이름에 점(.)이 포함된 새 교정쇄 버전을 업로드할 때 파일 이름의 끝부분이 잘립니다.

+++

+++**2021년 7월 19일 화요일 유지 관리 업데이트 (핫픽스)**

**프로젝트, 타임시트, 작업 또는 프로그램으로 이동하는 동안 오류 발생**

새 [!DNL Adobe Workfront] 경험에서 사용자가 프로젝트, 타임시트, 작업 또는 프로그램으로 이동할 때 다음과 같은 오류 메시지가 표시됩니다. “[!UICONTROL 죄송합니다. 문제가 발생했습니다. 문제점과 수정 방법을 확인하려면 [!DNL Workfront]로 연락하십시오.]”

+++

+++**2021년 7월 15일 금요일 유지 관리 업데이트**
...
**[!UICONTROL 교정쇄로 이동] 링크가 댓글로 연결되지 않음**

_이메일 알림_

사용자가 교정쇄 댓글에 대한 이메일 알림을 받고 [!UICONTROL 교정쇄로 이동]을 클릭하면 교정쇄 내 잘못된 댓글로 연결되거나 댓글이 전혀 연결되지 않습니다.
...
새 [!DNL Adobe Workfront] 경험의 사용자가 새 교정쇄를 만들 때 교정쇄에 대한 일부 사용자 정의 필드에 값을 입력하면 일부 이전 필드의 값이 사용자가 입력한 값이 아닌 기본값으로 되돌아갑니다.
...
+++**[!DNL Adobe Workfront Fusion]2021년 7월 1일 금요일 유지 관리 업데이트**
...
+++**2021년 7월 1일 금요일 유지 관리 업데이트**

**카드에 대해 설정된 색상이 적용되지 않음**

_칸반_

새 [!DNL Adobe Workfront] 경험의 사용자가 팀 설정에서 특정 카드 색상을 설정할 때 해당 색상이 칸반 카드에 반영되지 않습니다.

**사용자 정의 메시지 필드에 텍스트를 붙여넣을 수 없음**

_[!DNL Workfront Proof]_

사용자가 [!UICONTROL 웹 교정쇄 뷰어]에서 새 교정쇄를 만들 때 [!UICONTROL 이메일 알림] 섹션의 [!UICONTROL 메시지] 필드에 텍스트를 붙여넣으려고 하면 텍스트를 붙어넣을 수 없습니다. 이 문제는 텍스트에 단락 서식이 적용되어 있고 단락 나누기가 있는 경우에만 발생하는 것 같습니다.
...
새 [!DNL Adobe Workfront] 경험의 사용자가 사용자 정의된 [!UICONTROL 추가 필드] 열을 칸반 보드에 추가하면 보드에서 모든 열 머리글 표시가 중지됩니다.

+++

+++**[!DNL Adobe Workfront Fusion]2021년 6월 23일 목요일 유지 관리 업데이트**
...
**[!UICONTROL 새 교정쇄] 페이지의 일부 구문이 올바르게 번역되지 않음**

_[!DNL Workfront Proof]_

사용자가 [!DNL Workfront Proof]에서 [!UICONTROL 새 교정쇄 만들기] 페이지로 이동하여 콘텐츠를 영어가 아닌 언어로 번역할 때 일부 구문이 여전히 영어로 표시됩니다.

**비활성화됨 및 삭제됨 레이블이 사용자[!DNL Workfront Proof]**&#x200B;에 추가됨

_[!DNL Workfront Proof]_

[!UICONTROL 비활성화됨] 및 [!UICONTROL 삭제됨] 사용자 레이블이 [!DNL Workfront] 교정쇄의 다음 영역에 추가되었습니다.

* [!UICONTROL 교정쇄 세부 정보] 페이지
* [!UICONTROL 교정 보기]
* [!UICONTROL 교정쇄 뷰어]
* [!UICONTROL 교정 워크플로]
* [!UICONTROL 댓글 인쇄] 페이지
...
+++**2021년 5월 20일 금요일 유지 관리 업데이트**

**교정쇄 옵션이 없음**

_교정쇄_

사용자가 [!DNL Workfront]에서 다른 버전의 교정쇄를 업로드할 때 [!UICONTROL 교정쇄 열기] 및 [!UICONTROL 교정 워크플로] 링크가 표시되지 않아 교정쇄가 아닌 문서처럼 보일 수 있습니다. 또한 해당 링크가 없을 때 [!UICONTROL 보류 중] 레이블이 표시되고 다른 사용자가 이 [!UICONTROL 보류 중] 상태에서 교정쇄를 생성할 수 없습니다.
...
사용자가 [!DNL Workfront Proof]에서 새 교정쇄를 만들 때 이메일의 텍스트를 [!UICONTROL 이메일 알림] 섹션의 [!UICONTROL 메시지] 필드에 붙여넣으려고 하면 텍스트를 붙여넣을 수 없습니다.
...
**이름이 새 교정쇄 이름과 일치하도록 업데이트되지 않음**

_문서_

사용자가 새 교정쇄 버전을 만들고 교정쇄 이름을 업데이트할 때 [!DNL Workfront]의 문서 오브젝트가 새 교정쇄 이름과 일치하지 않고 원래 이름으로 유지됩니다.
...
**보관된 교정쇄가 목록 및 보고서에 표시됨**

_교정쇄_

사용자가 [!UICONTROL 홈] 또는 [!UICONTROL 내 작업]에서 작업 목록을 볼 때 이미 보관되어 있는 교정쇄가 목록에 나타납니다. 보관된 교정쇄는 보고서와 대시보드에도 표시됩니다.
...
[!DNL Workfront]에서는 이제 포함된 각 파일별로 하나의 이메일을 보내는 대신 결합된 교정쇄에 대해 하나의 이메일을 보냅니다.
+++
...
+++**2021년 4월 8일 금요일 유지 관리 업데이트**

**[!DNL Adobe Creative Cloud] 통합에서 교정쇄를 만들 수 없음**

_Workfront 통합_

사용자가 [!DNL Adobe Creative Cloud]에서 직접 교정쇄를 만들려고 하면 교정쇄가 생성되지 않습니다.

+++

+++**2021년 4월 1일 금요일 유지 관리 업데이트**
...
기본 교정쇄 설정에서 [!UICONTROL 공개 공유]를 활성화한 사용자가 교정쇄를 만들 때, 공유가 비활성화된 상태로 교정쇄가 만들어집니다. 다른 사용자는 [!UICONTROL 공유] 버튼을 표시하거나 교정쇄를 공유할 수 없습니다.

**교정쇄를 만들 때 “[!UICONTROL 교정쇄를 생성하지 못함]” 오류 발생**

_[!DNL Workfront Proof]_

사용자가 교정쇄를 만들려고 할 때 교정쇄가 만들어지지 않고 다음과 같은 오류 메시지가 표시됩니다.

“[!UICONTROL 교정쇄를 생성하지 못함 -- 내부 오류]”
...
사용자가 [!DNL Workfront] API에서 기간을 사용하여 [!DNL Workfront] 모듈의 출력에 포함할 컬렉션 또는 참조 필드를 선택할 때 해당 모듈에 대한 출력에서 해당 필드가 콜론으로 구분되어 표시되고(예: [!UICONTROL owner:name]) 특성에도 표시됩니다(이름이 소유자 아래에 있는 필드임). 콜론으로 레이블 지정된 필드에는 데이터가 포함되어 있지 않고 시나리오의 뒷부분에서 모듈에 매핑될 때 잘못된 데이터를 제공합니다.
...
+++**2021년 3월 15일 화요일 유지 관리 업데이트 (핫픽스)**

**공유 구성 요소가 예상대로 작동하지 않음**

_[!DNL Workfront Proof]_

독립형 [!DNL Workfront Proof] 계정을 공유 구성 요소로 이동할 경우 새 버전의 교정쇄 또는 문서를 추가할 때 다음과 같은 기능이 발생할 수 있습니다.

* 사용자 [!UICONTROL Studio 교정쇄]를 삭제할 수 없습니다.
* 기본 메시지가 새 버전에 표시되지 않습니다.

**새 교정쇄 버전에서 공개 링크 공유가 활성화되지 않음**

_문서_

사용자가 교정쇄에서 공개 링크 공유를 활성화한 다음 새 교정쇄 버전을 업로드할 때 공개 링크 공유가 새 교정쇄 버전에서 자동으로 활성화되지 않습니다.

**[!UICONTROL 승인], [!UICONTROL 변경], [!UICONTROL 거부] 버튼이 교정쇄에 없음**

_[!DNL Workfront Proof]_

사용자가 교정쇄 뷰어에서 교정쇄를 볼 때 [!UICONTROL 승인], [!UICONTROL 변경] 및 [!UICONTROL 거부] 버튼이 화면 상단에 없습니다.
...
**교정쇄에 대한 사용자 정의 메시지가 새 버전에 이전되지 않음**

_[!DNL Workfront Proof]_

사용자가 사용자 정의 메시지를 교정쇄에 첨부한 다음 해당 교정쇄의 새 버전을 업로드할 때 사용자 정의 메시지가 새 교정쇄에 표시되지 않습니다.
...
**워크플로 설정에 상관없이 “[!UICONTROL 이 교정쇄에 대해 수신자에게 알림]” 옵션이 비활성화됨**

_[!DNL Workfront Proof]_

사용자가 새 교정쇄를 만들 때 “[!UICONTROL 이 교정쇄에 대해 수신자에게 알림]” 옵션을 수동으로 설정하지 않은 경우 해당 수신자에게 알림이 전송되지 않습니다. 이는 워크플로 설정에서 옵션을 활성화한 경우에도 마찬가지입니다.
...
사용자가 [!UICONTROL 교정쇄 뷰어]에서 문서를 다운로드할 때 문서 이름이 다운로드한 버전이 아닌 이전 문서 버전과 같습니다.

+++

+++**2021년 3월 4일 금요일 유지 관리 업데이트**
...
“[!UICONTROL 사용자가 더 이상 존재하지 않습니다. 웹 주소를 잘못 입력했을 수 있습니다. 주소를 확인한 후 다시 입력해 보십시오.]”

**사용자가 태그 지정된 교정쇄 댓글로 리디렉션되지 않음**

_이메일 알림_

사용자가 교정쇄 댓글에서 태그 지정한 후 이메일 알림에서 [!UICONTROL 교정쇄로 이동] 링크를 클릭하면 특정 댓글이 아닌 교정쇄로 이동됩니다. [!DNL Workfront Classic]에서는 교정쇄의 댓글 대신 [!UICONTROL 문서 세부 정보] 페이지로 이동합니다.

**[!DNL Workfront] 단계에 추가된 사용자가 이메일 알림을 수신함**

_[!DNL Workfront Proof]_

워크플로에 없는 사용자가 [!DNL Workfront]에서 교정쇄를 열 경우 시스템에서 단계를 자동으로 만들고, 이 사용자를 교정쇄에 추가하고, [!UICONTROL 새 교정쇄] 이메일 알림을 보냅니다.
...
+++**2021년 3월 1일 화요일 유지 관리 업데이트 (핫픽스)**
...
새 [!DNL Workfront] 경험의 사용자가 일부 문서 링크를 클릭하면 문서에 액세스할 수 없고 다음과 같은 오류 메시지가 표시됩니다. “[!UICONTROL 문서가 더 이상 존재하지 않습니다. 웹 주소를 잘못 입력했을 수도 있습니다. 주소를 확인한 후 다시 입력해 보십시오.]” 증명 이메일 알림의 [!UICONTROL 세부 정보 보기] 링크에서도 이 오류가 발생합니다.
...
+++**2021년 2월 11일 금요일 유지 관리 업데이트**

**교정쇄가 선택된 폴더에 업로드되지 않음**

_[!DNL Workfront Proof]_

사용자가 폴더를 열고 새 교정쇄를 추가할 때 교정쇄가 폴더 내부가 아닌 프로젝트의 일반 [!UICONTROL 문서] 영역에 로드됩니다.
...
새 [!DNL Workfront] 경험의 사용자가 외부 문서 공급자의 새 요청에 문서를 추가하려고 할 때 [!UICONTROL 문서] 목록이 로드되지 않아 사용자가 문서를 선택하고 요청을 완료할 수 없습니다.
...
**“[!UICONTROL URL 또는 임베드 코드를 통한 교정쇄 공유 허용]” 설정이 변경됨**

_[!DNL Workfront Proof]_

사용자가 교정쇄를 만든 후 [!UICONTROL URL 또는 임베드 코드를 통한 교정쇄 공유 허용] 설정을 선택 해제할 경우 교정쇄가 생성된 이후에 이 설정이 다시 선택됩니다. 설정을 선택된 상태로 두면 교정쇄가 생성된 이후에 설정이 선택 해제됩니다.

**[!DNL Mac]사용자가 교정쇄 뷰어의 텍스트 필드에 붙여넣을 수 없음**

_[!DNL Workfront Proof]_

사용자가 교정쇄 뷰어의 특정 필드에 텍스트를 붙여넣으려고 하면 텍스트가 필드에 표시되지 않습니다.

+++

+++**2021년 1월 14일 금요일 유지 관리 업데이트**

**이메일 알림 설정을 업데이트할 수 없음**

_설정_

사용자가 이메일 알림에 대한 설정을 업데이트하려고 하면 [!UICONTROL 이메일 알림] 영역에 액세스할 수 없고 다음과 같은 오류 메시지가 표시됩니다. “[!UICONTROL 다시 시도해 보겠습니다. 죄송합니다. 문제가 발생했습니다. 문제점과 수정 방법을 확인하려면 [!DNL Workfront]로 연락하십시오.]”
...
사용자가 새 [!DNL Workfront] 경험에서 문서 또는 교정쇄를 이동할 때 프로젝트 외부의 일부 작업에서 상위 프로젝트가 예상대로 나열되지 않습니다.

**다운로드된 PDF의 이름이 잘못됨**

_[!DNL Workfront Proof]_

사용자가 이메일을 통해 다운로드 링크를 수신하고([!UICONTROL 교정쇄] > [!UICONTROL 댓글 인쇄] > [!UICONTROL PDF]) 파일을 내보낼 경우 다운로드한 파일의 제목이 교정쇄 ID 대신 임의의 숫자로 지정됩니다.
