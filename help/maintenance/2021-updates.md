...
사용자가 [!DNL Workfront]에서 다른 버전의 증명을 업로드할 때 [!UICONTROL 증명 열기] 및 [!UICONTROL 증명 워크플로] 링크가 표시되지 않아 증명이 아닌 문서처럼 보일 수 있습니다. 또한 해당 링크가 없을 때 [!UICONTROL 보류 중] 레이블이 표시되고 다른 사용자가 이 [!UICONTROL 보류 중] 상태에서 증명을 생성할 수 없습니다.
